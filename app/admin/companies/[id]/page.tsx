...
export default function CompanyEditPage() {
  ...
  return (
    <div>
      ...
      {message && (
        <div className={`mb-4 px-4 py-2 rounded text-sm ${message.startsWith('Błąd') ? 'bg-red-50 text-red-700' : 'bg-green-50 text-green-700'}`}>
          {message}
        </div>
      )}
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Field label="Nazwa firmy" name="name" value={form.name} onChange={onChange} placeholder="Bawaria Development sp. z o. o." />
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base flex items-center justify-between">
                ...
                <span className="text-sm font-normal text-gray-500">{assignedUnitIds.size} działek</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {showSelector && (
                <div className="border rounded-lg p-4 bg-gray-50 space-y-4 max-h-[500px] overflow-y-auto">
                  <p className="text-xs text-gray-500">Zaznacz działki przypisane do tej firmy. Możesz zaznaczyć cały budynek.</p>
